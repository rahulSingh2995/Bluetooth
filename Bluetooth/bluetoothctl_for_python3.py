...
if __name__ == "__main__":
    ...
    list_of_avl_devices = bl.get_available_devices()
    
    #print(type(list_of_devices))
    #print(type(list_of_devices[0]))

    print("Available Devices-")
    for i in list_of_avl_devices:
        print(i)

    """for i in list_of_avl_devices:
        if i["name"]=="Singh":
            bl.connect(i["mac_address"])"""
    ...
    print(list_of_avl_devices[0]["mac_address"])
    bl.pair(list_of_avl_devices[0]["mac_address"])
    bl.connect(list_of_avl_devices[0]["mac_address"])
    
    #print(list_of_devices[1]["mac_address"])
    #bl.connect(list_of_devices[])
